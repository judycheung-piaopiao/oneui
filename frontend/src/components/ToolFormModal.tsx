...
export default function ToolFormModal({ tool, onClose }: ToolFormModalProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (tool) {
        await updateTool(tool.id, cleanedData);
      } else {
        await createTool(cleanedData);
      }
      onClose();
    } catch (err: any) {
      ...
      if (typeof errorMsg === 'string') {
        ...
        setError(errorMsg.map((e: any) => `${e.loc?.join('.')}: ${e.msg}`).join(', '));
      } else {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none resize-none text-gray-900 bg-white"
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-gray-900 bg-white"
              placeholder="https://tool.alpha-grep.com"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-gray-900 bg-white"
              placeholder="https://docs.alpha-grep.com"
            />
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-gray-900 bg-white"
                placeholder="e.g., traders, HR, devops"
              />
              <button
                type="button"
